  ...
  return (
    <div className=" bg-gray-100 min-h-screen">
      <div className="w-11/12 mx-auto flex flex-col md:flex-row gap-6 p-6">
        ...
        {/* Right - Cart */}
        <div className="w-full md:w-1/2 bg-white shadow-lg rounded-2xl p-4 md:p-6 space-y-4">
          ...
          {cart.length === 0 ? (
            ...
            <div className="space-y-4">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 p-4 border rounded-xl shadow-sm"
                >
                  {/* Image & Info */}
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <h4 className="font-semibold text-sm sm:text-base truncate max-w-[150px] sm:max-w-[200px]">
                        {item.name}
                      </h4>
                      <p className="text-gray-500 text-sm">Price: ৳{Number(item.new_price) || 0}</p>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    ...
                    <button
                      ...
                      className="text-red-500 mt-1 text-sm sm:text-base"
                    >
                      🗑
                    </button>
                  </div>
          ...
          {/* Summary */}
          <div className="mt-6 border-t pt-4 space-y-2 text-sm sm:text-base">
